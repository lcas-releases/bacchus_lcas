## bacchus_teaching (melodic) - 0.3.3-1

The packages in the `bacchus_teaching` repository were released into the `melodic` distro by running `/home/marchanheide/.local/bin/bloom-release -t melodic -r melodic bacchus_teaching` on `Tue, 30 Nov 2021 00:09:53 -0000`
...
## bacchus_teaching (melodic) - 0.3.2-2

The packages in the `bacchus_teaching` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -y --no-web -t melodic -r melodic bacchus_teaching` on `Mon, 29 Nov 2021 17:59:26 -0000`
...
## bacchus_teaching (melodic) - 0.3.2-1
